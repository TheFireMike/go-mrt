...
const (
	...
	TABLE_DUMP_V2_SUBTYPE_RIB_IPv4_UNICAST_ADDPATH   = 8
	TABLE_DUMP_V2_SUBTYPE_RIB_IPv4_MULTICAST_ADDPATH = 9
	TABLE_DUMP_V2_SUBTYPE_RIB_IPv6_UNICAST_ADDPATH   = 10
	TABLE_DUMP_V2_SUBTYPE_RIB_IPv6_MULTICAST_ADDPATH = 11
	TABLE_DUMP_V2_SUBTYPE_RIB_GENERIC_ADDPATH        = 12
)
...
func (r *TableDumpV2RIB) DecodeBytes(data []byte) error {
	...
	for i := 0; i < n; i++ {
		...
		if r.subtype == TABLE_DUMP_V2_SUBTYPE_RIB_IPv4_UNICAST_ADDPATH ||
			r.subtype == TABLE_DUMP_V2_SUBTYPE_RIB_IPv4_MULTICAST_ADDPATH ||
			r.subtype == TABLE_DUMP_V2_SUBTYPE_RIB_IPv6_UNICAST_ADDPATH ||
			r.subtype == TABLE_DUMP_V2_SUBTYPE_RIB_IPv6_MULTICAST_ADDPATH {
...
const (
	...
	BGP4MP_SUBTYPE_BGP4MP_MESSAGE_ADDPATH           = 8
	BGP4MP_SUBTYPE_BGP4MP_MESSAGE_AS4_ADDPATH       = 9
	BGP4MP_SUBTYPE_BGP4MP_MESSAGE_LOCAL_ADDPATH     = 10
	BGP4MP_SUBTYPE_BGP4MP_MESSAGE_AS4_LOCAL_ADDPATH = 11
)
...
func (r *BGP4MPMessage) DecodeBytes(data []byte) error {
	...
	as4 := r.subtype == BGP4MP_SUBTYPE_BGP4MP_MESSAGE_AS4 ||
		...
		r.subtype == BGP4MP_SUBTYPE_BGP4MP_MESSAGE_AS4_ADDPATH ||
		r.subtype == BGP4MP_SUBTYPE_BGP4MP_MESSAGE_AS4_LOCAL_ADDPATH
	if as4 {
		r.PeerAS = d.as4()
		r.LocalAS = d.as4()
	} else {
...
func (r *Reader) Next() (Record, error) {
	...
	case TYPE_BGP4MP, TYPE_BGP4MP_ET:
		...
		case BGP4MP_SUBTYPE_BGP4MP_MESSAGE,
			...
			BGP4MP_SUBTYPE_BGP4MP_MESSAGE_ADDPATH,
			BGP4MP_SUBTYPE_BGP4MP_MESSAGE_AS4_ADDPATH,
			BGP4MP_SUBTYPE_BGP4MP_MESSAGE_LOCAL_ADDPATH,
			BGP4MP_SUBTYPE_BGP4MP_MESSAGE_AS4_LOCAL_ADDPATH:
